...
const port = process.env.PORT || 3030;   //setting up the port number for heroku
...
app.listen(port,() => {            //it helps to bind the app to port on our machine
console.log(`server is up on port 3030 ${port}`);
});
